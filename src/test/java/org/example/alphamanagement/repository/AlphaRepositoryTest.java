...
//        ArrayList<String> skilz = new ArrayList<>(List.of());
...
//       String actual = alphaRepository.findProjectByID(1).getProjectName();
//       String expected = "Testprojekt";
//       assertEquals(actual,expected);
//   }
//
//
...
//       int actual = alphaRepository.getProjectsForEmp("kabj0000").size();
//       int expected = 1;
//       assertEquals(actual,expected);
//    }
//
...
//        alphaRepository.createSubProject(1,project);
//        int actual = alphaRepository.getAllSubProjectsOfProject(1).size();
//        int expected = 1;
//        assertEquals(expected,actual);
//    }
//
...
//
//    }
//// TODO : SPØRG UNDERVISER OMKRING DENNE TEST
//    @Test
...
//      assertEquals(actual,expected);
//    }
////TODO: Lav eventuel test for toggleIsDone eller drop det fordi den er void
//
//
//    //TODO SPØRG MADS
////    @Test
...
////        Task task = new Task("Taskname",1,"taskd",2, startDate,endDate);
////
////        task.setTaskName("ChangedTaskName");
////       Task actual = alphaRepository.updateTask(task);
////       Task expected = task.getTaskName().equals("ChangedTaskName");
////    assertEquals(actual,expected);
////
////    }
//
...
//        alphaRepository.updatehoursDone(3,1);
